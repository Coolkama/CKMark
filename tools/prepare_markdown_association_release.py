...
if "<strong>Version 1.3.0</strong>" in html:
    print("ScienceMD About information already shows version 1.3.0.")
    raise SystemExit(0)
...
if old not in html:
    raise SystemExit("Expected ScienceMD 1.2.2 About version was not found")

INDEX.write_text(html.replace(old, new, 1), encoding="utf-8")
print("Updated ScienceMD About information to version 1.3.0.")
